...
mod mode {
    ...
    pub use ilps22qs_rs::asynchronous as ilps22qs;
...
mod mode {
    ...
    pub use ilps22qs_rs::blocking as ilps22qs;
    pub use cortex_m_rt::interrupt;
}

pub use mode::*;
pub use ilps22qs::I2CAddress;
...
define_embassy_with_st_link! {
    i2c = {
        address: I2CAddress::SD0High as u8,
        periph: I2C1,
        scl: PB8,
        sda: PB9,
        ev_irq: I2C1_EV,
